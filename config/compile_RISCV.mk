...
CFLAGS        := -Os -march=rv32i -mabi=ilp32 -mcmodel=medany -ffunction-sections -fdata-sections -g -Ilogiciel/apps
#CFLAGS_FEMTO  := -I$(FEMTO_DIR)/include -I$(FEMTO_DIR)/include/arch/riscv -DENV_FPGA=1
CFLAGS_FEMTO  := -I$(FEMTO_DIR)/libfemto/include -I$(FEMTO_DIR)/env/common -I$(FEMTO_DIR)/env/common/rv32 -I$(FEMTO_DIR)/env/cep_riscv -DENV_FPGA=1
